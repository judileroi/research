...
class PostereditType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
                ->add('titreFr', null, array('label' => 'Titre du Poster (*)', 'required' => false))
                ...
                ->add('affiliation', null, array('label' => 'Affiliation', 'required' => false,))
...
->add('datePubli', ChoiceType::class, array('label' => 'Année de publication (*)', 'choices' => array(
                ...
                ->add('Enregistrer le poster', SubmitType::class)
        ;
    }
