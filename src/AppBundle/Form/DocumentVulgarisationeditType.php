...
class DocumentVulgarisationeditType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
                ->add('titreFr', null, array('label' => 'Titre du document de vulgarisation (*)', 'required' => false))
...
->add('datePubli', ChoiceType::class, array('label' => 'Année de publication (*)', 'choices' => array(
                ...
                ->add('Enregistrer le document', SubmitType::class)
        ;
    }
